...
void Renderer::render(const Matrix44F& projectionMatrix, const Matrix44F& cameraview, Vec2F size)
{
    ...
    const GLfloat pyramid_vertices[8][3] = {
        /* +z */{size[0]+50000, size[1], height}, {size[0]+50000, -size[1], height}, {-size[0]+50000, -size[1], height}, {-size[0]+50000, size[1], height},
        /* -z */{(size[0]+50000) / 2, size[1] / 2, 0}, {(size[0]+50000) / 2, -size[1] / 2, 0}, {(-size[0]+50000) / 2, -size[1] / 2, 0}, {(-size[0]+50000) / 2, size[1] / 2, 0}};
    glBufferData(GL_ARRAY_BUFFER, sizeof(pyramid_vertices), pyramid_vertices, GL_DYNAMIC_DRAW);
    ...
    const GLfloat pyramid_vertices_2[8][3] = {
        /* +z */{size[0] / 2+3, size[1] / 2, size[0] / 2},{size[0] / 2 + 3, -size[1] / 2, size[0] / 2},{-size[0] / 2 + 3, -size[1] / 2, size[0] / 2},{-size[0] / 2 + 3, size[1] / 2, size[0] / 2},
        /* -z */{size[0] / 4+3, size[1] / 4, 0},{size[0] / 4 + 3, -size[1] / 4, 0},{-size[0] / 4 + 3, -size[1] / 4, 0},{-size[0] / 4 + 3, size[1] / 4, 0}};
